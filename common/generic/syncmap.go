...
// modified from https://github.com/zolstein/sync-map/blob/master/map.go
...
// [SyncMap.Load], [SyncMap.LoadAndDelete], [SyncMap.LoadOrStore], and [Map.Swap] are read operations;
// [SyncMap.Delete], [SyncMap.LoadAndDelete], [SyncMap.Store], and [Map.Swap] are write operations;
// [SyncMap.LoadOrStore] is a write operation when it returns loaded set to false.
//
...
// from the dirty map.
// Because the same expunged pointer is used regardless of the SyncMap's value type,
